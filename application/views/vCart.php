            ...
            <div class="twelve wide column">
                <div class="ui left aligned middle aligned grid">
                    ...
                    <?php if(isset($items)) { ?>
								...
								<div class="ui segment">
									<div class="ui grid">
										...
										<div class="eleven wide left aligned column">
											...
											<span class="prodName"><?php echo $prod->product_name; ?></span><br> <br>
						...
						<?php }?>
					<!-- computer -->
					<div class="twelve wide computer only column"></div>
					<div class="four wide computer only left aligned column">
						<?php if (isset($total)) {?>
